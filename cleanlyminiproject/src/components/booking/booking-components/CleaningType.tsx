...
export default function CleaningType(): JSX.Element {
  ...
  const selectedCleaningType=useSelector((state: RootState) => state.booking.cleaningType);
    ...
    <div className="cleaning-types-container">
      ...
      <div className="cleaning-type">
        {cleaningTypes.map((cleaningType) => (
          <button type="button" 
          className={`cleaning-type-button ${cleaningType.type === selectedCleaningType ? "active" : ""}`}
