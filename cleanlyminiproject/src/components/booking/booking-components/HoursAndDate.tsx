    ...
    <div className="schedule-container">
      ...
      <div className="schedule-hour-date">
        <div className="schedule-hour-container">
          <div className="schedule-hour-heading">How many hours?</div>
          <div className="schedule-hour-field">
            <button className="hour-btn" onClick={handleAddHours}>
              +
            </button>
            <div className="hour-count">{hours}</div>
            <button className="hour-btn" onClick={handleSubtractHours}>
              -
            </button>
          </div>
        </div>
        <div className="schedule-date-container">
          <div className="schedule-date-heading">Choose a date?</div>
          <input
            type="date"
